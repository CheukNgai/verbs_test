...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    # in memory.
    train_dataset_filename = os.path.join(FLAGS.output_dir, "train.tf_record")
    if not os.path.exists(train_dataset_filename):
    ...
    train_input_fn = input_fn_builder(
        input_file=train_dataset_filename,
